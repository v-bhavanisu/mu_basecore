...
MOCK_FUNCTION_DEFINITION (MockPciIoProtocol, MockPciIoRead, 5, EFIAPI);
...
EFI_PCI_IO_PROTOCOL  PCI_IO_PROTOCOL_MOCK = {
  ...
  NULL, // EFI_PCI_IO_PROTOCOL_ACCESS                Mem;
  NULL, // EFI_PCI_IO_PROTOCOL_ACCESS                Io;
  Pci,  // EFI_PCI_IO_PROTOCOL_CONFIG_ACCESS         Pci;
  ...
  NULL, // EFI_PCI_IO_PROTOCOL_GET_LOCATION          GetLocation;
